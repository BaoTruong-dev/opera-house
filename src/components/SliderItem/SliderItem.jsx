  ...
  return (
    <>
      <div className="sliderItem">
        ...
        <div
          className="sliderItem-icon nextEl"
        >
          <svg
            width="19"
            height="16"
        ...
        <div className="sliderItem-icon">
          <svg width="19" height="16" viewBox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6.35288e-05 9.00003L14.5861 9.00003L9.29306 14.293L10.7071 15.707L18.4141 8.00003L10.7071 0.293028L9.29306 1.70703L14.5861 7.00003L6.37037e-05 7.00003L6.35288e-05 9.00003Z" fill="#B4B4B4" />
          </svg>
        </div>
      </div>
    </>
